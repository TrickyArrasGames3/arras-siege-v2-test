        ...
        if (!(0.05 > u)) {
          ...
          if (somethinglolcuzimlazy == "") { // if it's a beta tester, render it yellow
            c.nameplate &&
              ...
              (g.globalAlpha = 1));
          } else { //otherwise render it white
            c.nameplate &&
              c.id !== A.playerid &&
              (null == c.render.textobjs && (c.render.textobjs = [m(), m()]),
              (d = c.name),
          ...
          return (c) => {
            ...
            if (!b.hideGui) {
              ...
              }
              {
                ...
                g.lineWidth = 4;
                if (z.key == somethinglolcuzimlazy) {
                  N.draw(
                    z.name,
...
if (b.label.includes('[AI] '))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "#D9D1FF", "center", !0);
if (b.label.includes('‮noremaKorP'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "#00FFFF", "center", !0);
//if (b.label.includes('ee'))ca[a].draw(b.label + ": " + H.handleLargeNumber(Math.round(b.score)), c + 100, d + 7, 9, "#D9D1FF", "center", !0);
// Add your own!
    ...
    function (r) {
      ...
      const e = {
       ...
       // KEY_CLASS_TREE: 84,
        ...
        KEY_MOUSE_2: 16,
        KEY_CHAT: 72, // Chat (h)
        KEY_FUCK_YOU: 192, // TESTBED (`)
        KEY_GOD: 186, // God Mode (;)
        KEY_KILL_YOURSELF: 79, //Suicide (O)
        KEY_TELEPORT: 84, //Teleport (T)
        ...
        servers: [
          ...
          },
          {
            ...
            type: "1ffa",
            code: "ffa-f",
            at: p.replit("arras-siege-2-test.idontneedtea"), //Server Here!
          },
        ]
          .map((a, e) => ({
            data: a,
